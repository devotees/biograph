...
def timespan(start_isodate, end_isodate, **kwargs):
    ...
    # Drawing
    # Monday to Friday
    text(mid(options.left_grid, weekday_right_grid)-60, top_grid-45, 'Weekdays', class_="axis_label")
    ...
    # ZzzzzzZZZ
    text(mid(weekend_right_grid, options.right_grid)-15, top_grid-45, 'zzz', class_="axis_label")
